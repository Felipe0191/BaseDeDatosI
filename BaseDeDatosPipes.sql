...
INSERT INTO ELiquids(NameELiquids,PriceELiquids)
			VALUES('Pipe Vape',150),
                  ...
                  ('Blue Moon',150);
UPDATE Customers
SET NameCustomers = 'Pablo Mora'
WHERE IDCustomer = 5;

UPDATE Vapes
SET NameVapes = 'Pastor Vape'
WHERE IDVapes = 2;

UPDATE Tools
SET NameTools = 'Vaporesso Xros P1 Plus'
WHERE IDTools = 4;

UPDATE Accessories
SET NameAccessories = 'Vaporesso iTank 30ml'
WHERE IDAccessories = 5;

UPDATE ELiquids
SET NameELiquids = 'Tostado Vape'
WHERE IDELiquids = 2;